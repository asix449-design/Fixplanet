# Religions pilot (1–400 CE) — overlay method

Five flat shelf cards. No globe, no Three.js, no Cesium, no year slider on a sphere.
...
(`world_100`, `world_200`, `world_300`, `world_400`), GPL-3.0.
...
- `public/images/maps/religion/y0600.png` — spread of Christianity to AD 600
  (CC BY-SA 3.0). Process companion. Primary on the 600 step; linked from 300/400.
...
at 2560×1280 plus a credit footer. Palette: tan land `#FFDF99`, sea `#C9EDFB`
(same family as History of borders plates).
