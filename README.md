...
| `/oceans` | Monitoring hub: named-gyre schematic + Copernicus/OSCAR explorers, NASA Aquarius salinity stills, GHRSST MUR SST scrubber (absolute 2003–2025 and anomaly 2020–2024), four separate pollution datasets (plastics / oil event / chlorophyll / dead zones), sourced heat–pH–plastic–hypoxia numbers. Deep links `/oceans/currents`, `/salinity`, `/sst`, `/pollution`, `/numbers`. Themed ISS-ocean backdrop |
