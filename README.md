...
| `/forests` | Forest photo hub: key FAO / GFW figures on the image, then shelf tiles. Satellite, reconstructions, numbers (sources), and outlook live on `/forests/satellite`, `/history`, `/numbers`, `/outlook` |
