...
| `/migration` | Hub tiles (Today / Humans / Great migrations). Current-day UN-region net-migration map on `/migration/today` (camps and Frontex detections as toggle layers). Event atlas on `/migration/humans`. Living mass movements on `/migration/great-migrations` (wildebeest, butterflies, Arctic birds — not Attila). Old `/migration/birds`, `/animals`, and `/hunnic-invasion` redirect. Detail pages at `/migration/[slug]` |
...
- Section themes: Maps uses NASA Blue Marble; Wildlife uses `public/images/wildlife/wildlife-section-bg.jpg` with a cream/dark scrim; Innovations uses `public/images/innovations/innovations-section-bg.jpg` (Earth + circuits, generated site theme) with a stronger cream/dark scrim; Forests hub uses `public/images/forests/forests-hub-bg.jpg` (clear sunlit pines, Ooty, CC BY-SA 4.0) with no fog overlay — headline stats sit on a translucent panel; shelf pages use `forests-section-bg.jpg` (sunlit Monterey pines at Point Lobos, CC BY-SA 2.0) without a milky wash; Oceans hub uses `public/images/oceans/oceans-hub-bg.jpg` (NASA ISS aerial Great Barrier Reef near the Whitsunday Islands, public domain — identifiable Commons/EO twin of the founder aerial-reef brief) with glass panels so headline stats stay readable on the turquoise water; shelf pages use `oceans-section-bg.jpg` (ISS Pacific sunglint, public domain) and a deeper navy/black scrim; Law uses a courthouse/parchment institutional backdrop; Terraforming uses NASA Toshka Lakes with an ochre / carved-earth scrim, distinct from forests green and innovations circuits. Other sections keep their own themes.
- Typeface: Inter
