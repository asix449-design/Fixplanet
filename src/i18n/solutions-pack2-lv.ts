...
export const pack2Lv: Record<string, SolutionCopy> = {
  ...
  'marine-protected-areas': {
    problemTitle: 'Jūras iezīmētas lietošanai, ne vietām, kur zveju un ieguvi aptur',
    fixTitle: 'Jūras aizsargājamās teritorijas',
    problem: 'Jūras iezīmētas lietošanai, ne vietām, kur zveju un ieguvi aptur',
    fix: 'Zonas ar skaidriem no-take vai ierobežotas lietošanas noteikumiem globālās MPA datubāzēs — laiks zivīm un biotopiem, ja aizsardzība ir reāla. Tas nav koraļļu vai jūraszāļu stādīšana.',
    imageAlt: 'Floridas Keys nacionālā jūras rezervāta pietauvošanās boju komanda darbā no mazas laivas',
  },
  'ballast-water-management': {
    problemTitle: 'Invazīvas sugas kuģu balasta tvertnēs',
    fixTitle: 'Balasta ūdeņu pārvaldība',
    problem: 'Invazīvas sugas kuģu balasta tvertnēs',
    fix: 'Balasta apstrāde vai maiņa pēc IMO konvencijas — filtri, UV, ķīmija uz kuģa, ne mangrovju projekts. Tas nav zaudētu tīklu savākšana.',
    imageAlt: 'Velkonis Boss izlaiž balasta ūdeni Brofjordenē, Zviedrijā, pirms iziešanas',
  },
  'shore-power': {
    problemTitle: 'Kuģi dedzina degvielu piestātnē gaismām, sūkņiem un viesnīcas slodzei',
    fixTitle: 'Kuģu krasta elektroapgāde',
    problem: 'Kuģi dedzina degvielu piestātnē gaismām, sūkņiem un viesnīcas slodzei',
    fix: 'Okeāna kuģu pieslēgšana krasta elektrībai ostā (cold ironing), lai izslēgtu palīgdzinējus. Tas nav atkritumu sadedzināšana vai siltumapgāde.',
    imageAlt: 'Kruīza kuģis Liberty of the Seas pieslēgts krasta elektroapgādei Kopenhāgenā',
  },
  'vessel-speed-reduction': {
    problemTitle: 'Korpusu triecieni vaļiem noslogotos piekrastes koridoros',
    fixTitle: 'Kuģu ātruma samazināšana vaļu dēļ',
    problem: 'Korpusu triecieni vaļiem noslogotos piekrastes koridoros',
    fix: 'Sezonāli ātruma limiti un ieteiktie maršruti samazina letālus triecienus — NOAA prakses. Tas nav selektīvie zvejas rīki pret piezveju.',
    imageAlt: 'Ziemeļatlantijas gludvalis pie virsmas Stellwagen Bank nacionālajā jūras rezervātā, NOAA foto',
  },
  'integrated-multi-trophic-aquaculture': {
    problemTitle: 'Vienas sugas būri bez partneriem, kas apēd atkritumus',
    fixTitle: 'Integrētā multitrofā akvakultūra',
    problem: 'Vienas sugas būri bez partneriem, kas apēd atkritumus',
    fix: 'Zivis kopā ar gliemenēm un aļģēm, kas uzņem barības un barībasvielu atlikumus — olbaltumvielas un tīrāks ūdens vienā nomā. Tas nav tikai brūnaļģu kultūra.',
    imageAlt: 'Gliemenes integrētās multitrofās akvakultūras vietā Fundi līcī, Kanādā',
  },
};
