...
const en = {
  ...
  home: {
    ...
    tiles: {
      ...
      migration: 'Human dispersal, bird flyways, and mammal migrations — with the drivers on each card.',
...
const ru: typeof en = {
  ...
  home: {
    ...
    tiles: {
      ...
      migration: 'Расселение человека, пролётные пути птиц и миграции млекопитающих — с факторами на каждой карточке.',
...
const pl: typeof en = {
  ...
  home: {
    ...
    tiles: {
      ...
      migration: 'Rozprzestrzenianie ludzi, szlaki ptaków i migracje ssaków — z czynnikami na każdej karcie.',
...
const lv: typeof en = {
  ...
  home: {
    ...
    tiles: {
      ...
      migration: 'Cilvēku izplatība, putnu lidojumu ceļi un zīdītāju migrācijas — ar dzinējspēkiem katrā kartītē.',
