...
const en = {
  ...
  home: {
    ...
    tiles: {
      ...
      oceans: 'Currents, salinity, SST, and sourced pollution layers — not a fake live ocean.',
...
const ru: typeof en = {
  ...
  home: {
    ...
    tiles: {
      ...
      oceans: 'Течения, солёность, SST и загрязнение с источниками — не фальшивый живой океан.',
...
const pl: typeof en = {
  ...
  home: {
    ...
    tiles: {
      ...
      oceans: 'Prądy, zasolenie, SST i warstwy zanieczyszczeń ze źródłami — nie fałszywy żywy ocean.',
...
const lv: typeof en = {
  ...
  home: {
    ...
    tiles: {
      ...
      oceans: 'Straumes, sāļums, SST un piesārņojuma slāņi ar avotiem — ne viltots dzīvais okeāns.',
